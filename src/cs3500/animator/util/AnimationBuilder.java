...
/**
 * Interface for the AnimationBuilder which builds an animations based on the info from a file.
 * @param <Doc>  file that provides the info necessary for the construction of an animation model.
 */
public interface AnimationBuilder<Doc> {
  ...
  /**
   * Adds a {@link ITimeInterval} to the list of intervals.
   * @param startTick the start tick of the interval
   * @param endTick the end tick of the interval
   * @param tempo the tempo tick of the interval
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<Doc> addInterval(int startTick, int endTick, int tempo);
